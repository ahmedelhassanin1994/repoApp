...
class ModelRepos {
  ...
  ModelRepos.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    nodeId = json['node_id'];
    name = json['name'];
    ...
    license = json['license'] != null ? new License_Response.fromJson(json['license']) : null;
...
class License_Response{
  ...
  License_Response(this.key, this.name, this.spdx_id, this.url, this.node_id);

  License_Response.fromJson(Map<String, dynamic> json) {
    key = json['key'];
    name = json['name'];
